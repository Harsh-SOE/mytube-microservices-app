...
import { GrpcApplicationErrorType } from '../common/grpc-exception';

export function isGrpcApplicationError(
  err: unknown,
): err is GrpcApplicationErrorType {
  ...
  const e = err as Partial<GrpcApplicationErrorType>;

  // if the err is ServiceError from Grpc then, It has:
  // 1. code of type number.
  // 2. details of type string

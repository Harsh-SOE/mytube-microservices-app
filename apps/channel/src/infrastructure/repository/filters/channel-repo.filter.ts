...
import { LoggerPort, LOGGER_PORT } from '@channel/application/ports';
import { AppConfigService, Components } from '@channel/infrastructure/config';
...
@Injectable()
export class ChannelRepoFilter {
